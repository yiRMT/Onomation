...
function Form() {
    ...
    const onSubmit = (data) => setData(data.text);
        ...
        <div className="flex flex-col container items-center ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col container items-center p-4">
                <div className="bottom-2">
                    ...
                    <input className="container border border-gray-500" id="Onomatope" placeholder="例:ザーザー" {...register('text')} />
                </div>
                
                <button type="submit" className="bg-gray-100 rounded-lg p-8  hover:shadow-xl  hover:ring-4 ring-red-500 duration-200">送信</button>
